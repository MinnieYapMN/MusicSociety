...
//        }  
    ...
    public static void addPayment() {
        ...
        try {
            ...
            for (int i = 1; i <= memberEvent.getSize(); i++) {
                if (regisNo.equals((memberEvent.getEntry(i).getRegisNo()))) {
                    ...
                    boolean paid = false;
                    while (!paid) {
                        if (paymentAmount >= eventList.getEntry(i).getFees()) {
                            double change = paymentAmount - eventList.getEntry(i).getFees();
                            System.out.printf("Change > %.2f\n", change);
                            paymentList.add(new Payment(date, time, event));
...
//
//                for (int i = 1; i <= paymentList.getSize(); i++) {
//                    if (paymentNo == paymentList.getEntry(i).getRegisNo().getEventD().getEntry(0).getEventNo()) {
//                        System.out.println(paymentList.getEntry(i));
//                        result = true;
//                    }
//                }
...
//
//                for (int i = 1; i <= paymentList.getSize(); i++) {
//                    if (sStudID.equals(paymentList.getEntry(i).getRegisNo().getMember().getEntry(0).getStudentID())) {
//                        System.out.println(paymentList.getEntry(i));
//                        result = true;
//                    }
//                }
...
//    }
    ...
    public static void generateReceipt() {
        ...
        String date = paymentList.getEntry(0).getPaymentDate();
        String time = paymentList.getEntry(0).getPaymentTime();
        ...
        //System.out.println("==================================================");
        System.out.print("\n");
        System.out.println("PaymentNo: " + paymentList.getEntry(0).getPaymentNo());
        System.out.println("Date: " + date + "\n" + "Time: " + time);
        System.out.println("Register No: " + paymentList.getEntry(0).getEvent().getRegisNo());
        System.out.print("\n");
        System.out.println("==================================================");
        System.out.println("ItemName\t\t\tQty\t Price(RM)");
        System.out.println("==================================================");

//        for (Event e : eventDList) {
//            System.out.printf("%-23s\t\t %d  \t %6.2f\n", e.getRegisNo(), e.getEventNo(), e.getEventD().getEntry(0).getFees());
//        }
        //System.out.println("DFF");
        System.out.println("--------------------------------------------------");
        System.out.println("Total Amount: \t\t\t\t " + String.format("%6.2f", paymentList.getEntry(0).getEvent().getEventD().getEntry(0).getFees()));
 //       System.out.println("Paid Amount" + ":\t\t\t\t\t " + String.format("%6.2f", paymentAmount));
 //       System.out.println("Change: \t\t\t\t " + String.format("%6.2f", paymentAmount - regisNo.getEventD().getEntry(0).getFees()));
        System.out.println("==================================================");
